...
export default function CaymusTanksPrivacy() {
  ...
  const content = {
    ...
    date: currentLanguage === 'en' ? 'May 8, 2026' : '8 de Mayo, 2026',
    ...
    sections: [
      ...
      },
      {
        ...
        content: currentLanguage === 'en'
          ? 'You have the right to:\n• Access the data stored locally on your device\n• Delete your calculation history and preferences\n• Request deletion of your account and associated data\n• Uninstall the application to delete all local data\n• Contact us to request information about your data\n• Manage or cancel your subscription at any time through the secure Chyrris billing portal. Access follows the current paid period and any configured grace period after failed renewal payments.'
          : 'Usted tiene derecho a:\n• Acceder a los datos almacenados localmente en su dispositivo\n• Eliminar su historial de cálculos y preferencias\n• Solicitar la eliminación de su cuenta y datos asociados\n• Desinstalar la aplicación para eliminar todos los datos locales\n• Contactarnos para solicitar información sobre sus datos\n• Gestionar o cancelar su suscripción en cualquier momento mediante el portal seguro de pagos de Chyrris. El acceso sigue el período pagado actual y cualquier período de gracia configurado después de fallos de renovación.'
      },
      {
        title: currentLanguage === 'en' ? '9. Subscription Terms' : '9. Términos de Suscripción',
        content: currentLanguage === 'en'
          ? '• Recommended annual subscription: $75.49/year, equivalent to a 10% discount versus paying monthly\n• Advanced monthly option: $6.99/month\n• Subscription provides full access to all calculator features\n• Payment is processed securely through Chyrris / Stripe\n• You can manage billing through the secure Chyrris portal\n• If a renewal payment fails, access may remain available for a 3-day grace period before being restricted\n• Refund handling follows Stripe/Chyrris billing policies and applicable law'
          : '• Suscripción anual recomendada: $75.49/año, equivalente a 10% de descuento frente al pago mensual\n• Opción mensual avanzada: $6.99/mes\n• La suscripción proporciona acceso completo a todas las funciones de la calculadora\n• El pago se procesa de forma segura mediante Chyrris / Stripe\n• Puede gestionar la facturación mediante el portal seguro de Chyrris\n• Si falla un cobro de renovación, el acceso puede mantenerse durante un período de gracia de 3 días antes de restringirse\n• Los reembolsos se gestionan según las políticas de facturación de Stripe/Chyrris y la ley aplicable'
      },
      {
